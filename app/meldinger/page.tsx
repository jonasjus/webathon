...
export default async function MessagesPage(props: MessagesPageProps) {
  ...
  return (
    <main className="min-h-screen bg-[var(--canvas)] px-4 py-6 sm:px-6 xl:h-[100dvh] xl:overflow-hidden xl:px-8">
      <div className="mx-auto grid max-w-[1440px] gap-6 xl:h-full xl:min-h-0 xl:grid-cols-[248px_minmax(0,1fr)]">
