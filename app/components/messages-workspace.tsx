      ...
      <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] shadow-[var(--shadow-card)]">
        <div className="border-b border-[var(--border)] px-5 py-5">
          <p className="text-sm font-medium text-[var(--ink-muted)]">
            Gruppechatter for aktivitetene dine
          </p>
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 text-xs uppercase tracking-[0.16em] text-[var(--ink-subtle)]">
                  ...
                  <p className="mt-3 line-clamp-2 min-h-10 text-sm leading-5 text-[var(--ink-muted)]">
                    {summary.lastMessagePreview ?? "Ingen meldinger enda."}
                  </p>
                </button>
              );
            })}
